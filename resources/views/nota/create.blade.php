                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            {{-- job --}}
                            <div class="row form-group">
                                <div class="col-12 col-md-12 text-center"><h4><b>Job dan Job detail</b></h4></div><br><br>
                                <div class="col col-md-2"><label for="email-input" class=" form-control-label">Email Input</label></div>

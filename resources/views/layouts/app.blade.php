...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-[#FEFFDB]">
        <nav class="flex justify-between items-center px-5 py-1 bg-white border">
            <div class="flex items-center gap-3">
                <img src="{{ asset('images/public/Logo.png') }}" alt="Company Logo" class="w-16">
                <span class="text-2xl font-bakbakOne ">Alban Technik Mandiri</span>
            </div>
            <div class="flex justify-between items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
                </svg>
                <img src="{{ asset('images/profiles/user1.jpg') }}" alt="Profile picture" class="w-12 h-12 rounded-full bg-contain bg-center cursor-pointer">
            </div>
        </nav>
        ...
        {{-- sidebar --}}
        {{-- <div class="bg-white px-2 py-4 w-1/5 border border-t-0 flex flex-col justify-between">
            <a href="#">asdf</a>
            <a href="#">asdf</a>
            <a href="#">asdf</a>
        </div> --}}

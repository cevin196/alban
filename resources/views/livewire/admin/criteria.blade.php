        ...
        <div class="modal-dialog relative w-auto pointer-events-none">
            <div
                ...
                <div
                    ...
                    <h5 class="text-xl font-medium leading-normal text-gray-800" id="deleteCriteriaModal">Hapus Kriteria
                    </h5>
                    <button type="button"
                ...
                <div class="modal-body relative p-4">
                    Apakah anda yakin ingin menghapus kriteria <span
                        class="text-amber-500">{{ $selectedCriteria ? $selectedCriteria->name : '' }}</span> dari
                    database?
                </div>
                <div

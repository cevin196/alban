                            ...
                            @foreach ($users as $user)
                                <a href="#">
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap gap-1">
                                            @foreach ($user->getRoleNames() as $role)
                                                <span
                                                    class="p-1 bg-amber-500 rounded text-white">{{ $role }}</span>
                                            @endforeach
                                        </td>
                                        <td class="text-sm text-gray-900 font-light">
                                            <div class="flex justify-around">
                                                ...
                                                <a href="#" title="Delete" data-bs-toggle="modal"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18"
                                                        height="18" fill="currentColor"
                                                        class="bi bi-trash3-fill text-red-500" viewBox="0 0 16 16">
                                                        <path

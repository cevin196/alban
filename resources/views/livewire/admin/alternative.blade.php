<div class="bg-white rounded p-5 mt-3 shadow-lg">
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('alternative.create') }}"
            class="px-2 py-1 rounded bg-green-500 text-white hover:bg-green-600">Add
            New</a>
    </div>
        ...
        <div class="modal-dialog relative w-auto pointer-events-none">
            <div
                ...
                <div
                    ...
                    <h5 class="text-xl font-medium leading-normal text-gray-800" id="deleteAlternativeModal">Delete User
                    </h5>
                    <button type="button"

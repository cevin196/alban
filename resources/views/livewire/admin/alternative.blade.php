<div class="bg-white rounded p-5 mt-3 shadow-lg">
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('alternative.create') }}"
            class="px-2 py-1 rounded bg-green-500 text-white hover:bg-green-600">Tambah Baru</a>
    </div>
                                ...
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="text-sm text-gray-900 font-light">
                                        <div class="flex justify-around">
                                            <a href="{{ route('alternative.show', $alternative->id) }}"
                                            ...
                                            <a href="{{ route('alternative.edit', $alternative) }}" title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            ...
                                            <a href="#" title="Delete" data-bs-toggle="modal"
                                                wire:click="confirmAlternativeDeletion({{ $alternative }})"
                                                data-bs-target="#deleteAlternativeModal">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
        wire:key="bar" id="deleteAlternativeModal" tabindex="-1" aria-labelledby="deleteAlternativeModal"
        ...
        <div class="modal-dialog relative w-auto pointer-events-none">
            <div
                ...
                <div
                    ...
                    <h5 class="text-xl font-medium leading-normal text-gray-800" id="deleteAlternativeModal">Delete
                        Alternatif
                    </h5>
                    <button type="button"
                ...
                <div class="modal-body relative p-4">
                    Apakah anda yakin ingin menghapus <span
                        class="text-amber-500">{{ $selectedAlternative ? $selectedAlternative->name : '' }}</span> from
                    dari database?
                </div>
                <div
                    ...
                    <button type="button" wire:click.prevent="deleteAlternative()"

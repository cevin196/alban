<div class="bg-white rounded p-5 mt-3 shadow-lg">
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('job.create') }}" class="px-2 py-1 rounded bg-green-500 text-white hover:bg-green-600">Tambah
            Baru</a>
    </div>
                        ...
                        <tbody>
                            @foreach ($jobs as $job)
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="text-white rounded p-1 {{ $color }}">{{ $job->status }}</span>
                                    </td>


                                    <td class="text-sm text-gray-900 font-light">
                                        <div class="flex justify-around">
                                            <a href="{{ route('job.print', $job) }}" title="Print" target="_blank">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                    width="18" height="18" class="text-gray-600">
                                            ...
                                            <a href="{{ route('job.show', $job->id) }}" title="Show Detail"
                                            ...
                                            <a href="{{ route('job.edit', $job) }}" title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            ...
                                            <a href="#" title="Delete" data-bs-toggle="modal"
                                                wire:click="confirmJobDeletion({{ $job }})"
        ...
        <div class="modal-dialog relative w-auto pointer-events-none">
            <div
                ...
                <div class="modal-body relative p-4">
                    Apakah anda yakin ingin menghapus data pekerjaan <span
                        class="text-amber-500">{{ $selectedJob ? $selectedJob->name : '' }}</span> dari database?
                    <br>
                    @if ($selectedJobRelationStatus)
                        <span class="text-red-500">Data ini memilki relasi ke data lain, menghapus data ini berarti
                            menghapus relasinya dengan data lain!</span>
                    @endif
                </div>
                <div

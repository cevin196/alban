<div class="bg-white rounded p-5 mt-3 shadow-lg">
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('job.create') }}" class="px-2 py-1 rounded bg-green-500 text-white hover:bg-green-600">Add
            New</a>
    </div>
            ...
            <div
                ...
                <div class="modal-body relative p-4">
                    Are you sure want to delete <span
                        class="text-amber-500">{{ $selectedJob ? $selectedJob->name : '' }}</span> from
                    Job table?
                </div>
                <div

...
@section('content')
    ...
    <div class="bg-white rounded p-5 mt-3 shadow-lg w-full">
        <span class="text-[#444444] font-bold text-lg">Edit Pengguna</span>
        ...
        <form class="mt-3" method="post" action="{{ route('user.update', $user) }}">
            ...
            <div class="grid grid-cols-3 gap-x-4 gap-y-3">
                ...
                <div class="form-group mb-3">
                    <label for="newPassword" class="form-label inline-block mb-2 text-gray-700">Password Baru</label>
                ...
                <div class="form-group mb-3 col-span-3">
                    <label for="role" class="form-label inline-block mb-2 text-gray-700">Peran</label>
                    <select name="roles[]"
                ...
                <div class="form-group mb-3 col-span-3">
                    <label for="role" class="form-label inline-block mb-2 text-gray-700">Izin Extra</label>

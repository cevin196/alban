...
@section('content')
    <div class="flex gap-1 text-xl items-center text-[#444444]">
        <a href="{{ route('criteria.index') }}" class="font-bold">Kriteria</a>
    ...
    <div class="bg-white rounded p-5 mt-3 shadow-lg w-full">
        <span class="text-[#444444] font-bold text-lg">Buat Kriteria Baru</span>
            ...
            <div class="grid grid-cols-12 gap-x-3">
                <div class="form-group mb-3 col-span-4">
                    ...
                    <input type="text" name="name"
                        ...
                        id="name" placeholder="Ex: Kriteria1" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="form-group mb-3 col-span-3">
                    <label for="inputWeight" class="form-label inline-block mb-2 text-gray-700">Bobot</label>
                    <input type="number" name="weight"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        id="inputWeight" placeholder="Ex: 3" value="{{ old('weight') }}">
                    <small class="block mt-1 text-xs text-gray-600">Bobot harus berupa angka antara 1-5</small>
                    @error('weight')
                        <small class="block mt-1 text-xs text-red-600">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3 col-span-3">
                    ...
                    <input type="text" name="unit"
                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        id="inputUnit" placeholder="Ex: Kilometer" value="{{ old('unit') }}">
                    @error('unit')
                        <small class="block mt-1 text-xs text-red-600">{{ $message }}</small>
                    @enderror
                </div>

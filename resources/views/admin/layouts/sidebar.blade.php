<div class="w-full lg:w-1/6 hidden lg:block h-full lg:top-0 pt-10 lg:pt-5 shadow-md bg-white fixed transition-all ease-in-out 
        ...
        <li class="relative" id="SideNavUser">
            <a href="{{ route('user.index') }}"
                ...
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="comments"
                    class="w-4 h-4 mr-2" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path fill="currentColor"
        ...
        <li class="relative" id="sidenavXxEx2">
            ...
            <ul class="relative accordion-collapse collapse" id="collapseSidenavXxEx2" aria-labelledby="sidenavXxEx2"
                ...
                <li class="relative">
                    <a href="#!"
                        class="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-amber-500 transition duration-300 ease-in-out"
                        data-mdb-ripple="true" data-mdb-ripple-color="orange">Link 5</a>
                </li>
                <li class="relative">
                    <a href="#!"
                        class="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-amber-500 transition duration-300 ease-in-out"
                        data-mdb-ripple="true" data-mdb-ripple-color="orange">Link 6</a>
                </li>
            </ul>
        </li>
        <li class="relative" id="sidenavXxEx3">
            ...
            <ul class="relative accordion-collapse collapse" id="collapseSidenavXxEx3" aria-labelledby="sidenavXxEx3"
                ...
                <li class="relative">
                    <a href="#!"
                        class="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-amber-500 transition duration-300 ease-in-out"
                        data-mdb-ripple="true" data-mdb-ripple-color="orange">Link 7</a>
                </li>
                <li class="relative">
                    <a href="#!"
                        class="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-amber-500 transition duration-300 ease-in-out"
                        data-mdb-ripple="true" data-mdb-ripple-color="orange">Link 8</a>
                </li>
            </ul>
        </li>
    </ul>
    <div class="text-center bottom-0 absolute w-full bg-white">
        <hr class="m-0">
        <p class="py-2 text-sm text-gray-700">Cevin Ananda Tamamilang</p>
    </div>
</div>

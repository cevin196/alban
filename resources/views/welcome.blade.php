        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('images\public\header1.jpg') }}" alt="Image" style="height: 100vh">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('images\public\header2.jpg') }}" alt="Image" style="height: 100vh">
                    <div class="carousel-caption d-flex align-items-center">
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex py-5 px-4">
                        ...
                        <div class="ps-4">
                            ...
                            <p>Service menggunakan standart pengerjaan dealer yang aman dan terpercaya</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="d-flex bg-light py-5 px-4">
                        ...
                        <div class="ps-4">
                            ...
                            <p>Dengan mekanik yang berpengalaman, menyediakan hasil pengerjaan yang optimal</p>
                            <a class="text-secondary border-bottom" href="">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="d-flex py-5 px-4">
                        ...
                        <div class="ps-4">
                            ...
                            <p>Pengerjaan unit menggunakan peralatan modern, lengkap dan sesuai dengan standart yang ada</p>
                            <a class="text-secondary border-bottom" href="">Read More</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 pt-4" style="min-height: 400px;">
                    <div class="position-relative h-100 wow fadeIn" data-wow-delay="0.1s">
                        <img class="position-absolute img-fluid w-100 h-100"
                            src="{{ asset('template/user/img/about.jpg') }}" style="object-fit: cover;" alt="">
                ...
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4"><span class="text-primary">Alban Technik Mandiri</span> Adalah Tempat Terbaik Untuk
                        Pengerjaan Unit Anda
                    </h1>
                    <p class="mb-4">Bengkel Alban Technik Mandiri pertama kali berdiri pada tahun 2013 di batu kajang,
                        Kabupaten Paser. Sejak awal Bengkel Alban Technik Mandiri memang memiliki fokus pengerjaan unit alat
                        berat (khususnya unit Caterpillar) dan juga mobil-mobil yang biasa digunakan di tambang. Kini
                        Bengkel Alban Technik Mandiri berada di Kota Balikpapan dan siap menangani pengerjaan unit anda baik
                        di baik di dalam, maupun diluar lokasi bengkel.</p>
                    ...
                    <a href="" class="btn btn-primary py-3 px-5">Lebih Lanjut<i
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <p class="text-white mb-0">Mekanik Ahli</p>
                </div>
                ...
                <div class="col-md-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.7s">
                    ...
                    <h2 class="text-white mb-2" data-toggle="counter-up">1235</h2>
                    <p class="text-white mb-0">Pekerjaan Terselesaikan</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4">
                    <div class="nav w-100 nav-pills me-4">
                        ...
                        <button class="nav-link w-100 d-flex align-items-center text-start p-4 mb-4" data-bs-toggle="pill"
                            ...
                            <h4 class="m-0">Service & Maintenance Unit</h4>
                        </button>
                        <button class="nav-link w-100 d-flex align-items-center text-start p-4 mb-4" data-bs-toggle="pill"
                            data-bs-target="#tab-pane-3" type="button">
                            <i class="fa fa-cog fa-2x me-3"></i>
                            <h4 class="m-0">Kerja Lokasi</h4>
                        </button>
                        <button class="nav-link w-100 d-flex align-items-center text-start p-4 mb-0" data-bs-toggle="pill"
                            ...
                            <h4 class="m-0">Service Mobil LV</h4>
                        </button>
                    </div>
                </div>
                <div class="col-lg-8">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute img-fluid w-100 h-100"
                                            src="{{ asset('images\public\service1.jpg') }}" style="object-fit: cover;"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="tab-pane fade" id="tab-pane-2">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute img-fluid w-100 h-100"
                                            src="{{ asset('template/user/img/service-2.jpg') }}"
                        ...
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute img-fluid w-100 h-100"
                                            src="{{ asset('template/user/img/service-3.jpg') }}"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="tab-pane fade" id="tab-pane-4">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute img-fluid w-100 h-100"
                                            src="{{ asset('template/user/img/service-1.jpg') }}"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6">
                    <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn"
                        data-wow-delay="0.6s">
                        <h1 class="text-white mb-4">Booking Layanan</h1>
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="date" id="date1" data-target-input="nearest">
                                        <input type="text" class="form-control border-0 datetimepicker-input"
                                            placeholder="Tanggal Service" data-target="#date1"
                                            data-toggle="datetimepicker" style="height: 55px;">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <textarea class="form-control border-0" placeholder="Permintaan khusus"></textarea>
                                </div>
                                <div class="col-12">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Teknisi Kami yang Berpengalaman</h1>
            </div>
            <div class="row g-4">
    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center">
                ...
                <h1 class="mb-5">Tanggapan Pelanggan Kami!</h1>
            </div>
            <div class="owl-carousel testimonial-carousel position-relative">
                <div class="testimonial-item text-center">
                    <img class="bg-light rounded-circle p-2 mx-auto mb-3"
                        src="{{ asset('template/user/img/testimonial-1.jpg') }}" style="width: 80px; height: 80px;">
                ...
                <div class="testimonial-item text-center">
                    <img class="bg-light rounded-circle p-2 mx-auto mb-3"
                        src="{{ asset('template/user/img/testimonial-2.jpg') }}" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Client Name</h5>
                    <p>Profession</p>
                    <div class="testimonial-text bg-light text-center p-4">
                        <p class="mb-0">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit diam amet diam et
                ...
                <div class="testimonial-item text-center">
                    <img class="bg-light rounded-circle p-2 mx-auto mb-3"
                        src="{{ asset('template/user/img/testimonial-3.jpg') }}" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Client Name</h5>
                    <p>Profession</p>
                    <div class="testimonial-text bg-light text-center p-4">
                        <p class="mb-0">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit diam amet diam et
                ...
                <div class="testimonial-item text-center">
                    <img class="bg-light rounded-circle p-2 mx-auto mb-3"
                        src="{{ asset('template/user/img/testimonial-4.jpg') }}" style="width: 80px; height: 80px;">
                    <h5 class="mb-0">Client Name</h5>
                    <p>Profession</p>
                    <div class="testimonial-text bg-light text-center p-4">
                        <p class="mb-0">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit diam amet diam et
